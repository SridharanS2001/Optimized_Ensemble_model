# -*- coding: utf-8 -*-
"""Thermal_hysteresis (M2)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1c4T6AuzmECnmJP5gAUNrLKMx8xcKObiJ
"""
...
model_definitions = {
    'SVR': Pipeline([
        ...
        ('model', SVR(C=56.517434778188, epsilon=1.0, gamma=0.000339087223247823, kernel='rbf'))
    ]),
    'RandomForest': Pipeline([
        ('scaler', StandardScaler()),
        ('model', RandomForestRegressor(bootstrap=True, max_depth=17, min_samples_leaf=5,
                                        min_samples_split=10, n_estimators=50, random_state=42))
    ]),
    'ExtraTrees': Pipeline([
        ('scaler', StandardScaler()),
        ('model', ExtraTreesRegressor(bootstrap=True, max_depth=5, min_samples_leaf=2,
                                      min_samples_split=10, n_estimators=300, random_state=42))
    ]),
    'GaussianProcess': Pipeline([
        ('scaler', StandardScaler()),
        ('model', GaussianProcessRegressor(alpha=0.005132631905819476, n_restarts_optimizer=9))
    ]),
    'KNN': Pipeline([
        ('scaler', StandardScaler()),
        ('model', KNeighborsRegressor(n_neighbors=11, p=2, weights='uniform'))
    ])
}
...
optimal_weights = [0.0, 0.0493, 0.7820, 0.1687, 0.0000]
...
train_df.to_csv('th_data_with_composition.csv', index=False)
